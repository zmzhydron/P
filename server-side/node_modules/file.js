...
/*
	...
	C:\MyCodeBase\nodejs\node_global\node_modules;
	C:\Users\zmz\Desktop\myProjects\node\node_modules;
	C:\Users\zmz\Desktop\bg;
	C:\Users\zmz\Desktop\myProjects\server-side
*/
		...
		case 'async':
			...
			fs.writeFile(origin,text,option,function(error){
				if(error){
					...
					ress.send('txt : '+text+" is successfully saved");
				}
			})
		break;
	}
...
var copy = {
	...
	setParams:function(obj,req,res,next){
		var buf = new Buffer(obj.text);
		var asd = new Buffer(256);
		console.log(buf);
		console.log("convert to String : "+buf.toString('utf8'));
		origin = obj.ori;
		target = obj.tar;
		syncType = obj.type || 'async';
		text = obj.text;
		// text = buf;
		res = res;
		ress = res;
